...
export function Navbar() {
  return (
    <nav className="flex w-full py-6 font-medium font-poppins">
      <div className="flex flex-row items-center justify-between w-full px-16 px-">
        ...
        <ul className="flex flex-row items-center text-base gap-x-20">
          <li className="overflow-hidden transition ease-in-out cursor-pointer hover:scale-105">
            Home
          </li>
          <li className="overflow-hidden transition ease-in-out cursor-pointer hover:scale-105">
            Shop
